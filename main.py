...
def main():
    ...
    # load dataset
    trainloader, valloader, testloader = get_dataloaders(args.method, args.batch_size, img_size = 32, val_ratio = 0.1)
    ...
    elif args.method in ["simclr", "moco_v1", "moco_v2"]:
        test_acc = knn_evaluation(model, valloader, testloader, device)
        print(f"Final kNN Test Accuracy(k=1): {test_acc*100:.2f}%")
